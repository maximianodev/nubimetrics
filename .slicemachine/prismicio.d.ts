 ...
 *
 */
interface HeroSliceSliderPrimary {
    /**
    ...
    /**
     * Texto de suporte field in *Hero → Primary*
     *
     * - **Field Type**: Text
     * - **Placeholder**: *None*
     * - **API ID Path**: hero.primary.texto_de_suporte
     * - **Documentation**: https://prismic.io/docs/core-concepts/key-text
     *
     */
    texto_de_suporte: prismicT.KeyTextField;
    /**
     * Imagem 1 field in *Hero → Primary*
     *
     * - **Field Type**: Image
     * - **Placeholder**: *None*
     * - **API ID Path**: hero.primary.image
    ...
    image: prismicT.ImageField<never>;
    /**
     * Imagem 2 field in *Hero → Primary*
     *
     * - **Field Type**: Image
     * - **Placeholder**: *None*
     * - **API ID Path**: hero.primary.imagem_2
     * - **Documentation**: https://prismic.io/docs/core-concepts/image
     *
     */
    imagem_2: prismicT.ImageField<never>;
    /**
     * Imagem 3 field in *Hero → Primary*
     *
     * - **Field Type**: Image
     * - **Placeholder**: *None*
     * - **API ID Path**: hero.primary.imagem_3
     * - **Documentation**: https://prismic.io/docs/core-concepts/image
     *
     */
    imagem_3: prismicT.ImageField<never>;
}
/**
 ...
 *
 */
export type HeroSliceSlider = prismicT.SharedSliceVariation<"slider", Simplify<HeroSliceSliderPrimary>, never>;
/**
 * Slice variation for *Hero*
 *
 */
type HeroSliceVariation = HeroSliceDefault | HeroSliceWithButton | HeroSliceSlider;
/**
 * Hero Shared Slice
 *
 * - **API ID**: `hero`
